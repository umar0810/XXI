var wsURL = "wss://5f47d7551ee0d.streamlock.net/webrtc-session.json";
...
function gotLocalDescription(description) {
    ...
    peerConnections[localUser].setLocalDescription(description, function () {
        let streamInfo = {applicationName: application, streamName: localUser}

        console.log('{"direction":"publish", "command":"sendOffer", "streamInfo":' + JSON.stringify(streamInfo) + ', "sdp":' + JSON.stringify(description) + ', "userData":' + JSON.stringify({}) + '}');
