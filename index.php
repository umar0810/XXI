...
<html class="no-js" lang="zxx">
   ...
   <body>
      ...
      <main>
         <!-- slider-area -->
         <section id="parallax" class="slider-area breadcrumb-area d-flex align-items-center justify-content-center fix" style="background-image:url(img/21cineplexbtc.jpg)">
             <!--<div id="iframebackground" class="slider-area slider-bg second-slider-bg slider-bg2 d-flex">
               <iframe id="bg" src="/img/21cineplexbtc.jpg" height="100%" width="100%" frameborder="0"></iframe>
             </div>-->
             <div class="container">
                 <div class="row">
                  ...
                  <div class="col-lg-6">
                     <div class="about-content s-about-content pl-30">
                        <div class="about-title second-atitle">
                           ...
                           <span class="wow fadeInUp animated" data-animation="fadeInUp animated" data-delay=".3s">Now Showing</span>
                           <h2 class="wow fadeInUp animated" data-animation="fadeInUp animated" data-delay=".4s">up Coming</h2>
                           <h5 class="wow fadeInUp animated" data-animation="fadeInUp animated" data-delay=".5s"><span></span>Nikmati Pengalaman Menonton Film Dengan IMAX dan Dolby Atmos</h5>
                        </div>
                        <div class="wow fadeInDown animated" data-animation="fadeInUp animated" data-delay=".2s">
                           <p>Selain menyajikan film-film hasil karya anak bangsa, CINEMA 21 juga menayangkan film-film berkelas dunia.
CINEMA 21 terus mengikuti perkembangan teknologi dengan melengkapi fasilitas-fasilitasnya seperti 2D dan 3D. Di tahun 2012, CINEMA 21 telah menghadirkan pengalaman nonton dengan teknologi revolusioner yaitu IMAX teater. Kini sudah ada tujuh teater IMAX yang dimiliki oleh CINEMA 21, yang berlokasi di Mal Gandaria City, Mal Kelapa Gading, Summarecon Mal Serpong, Summarecon Mal Bekasi, Tunjungan 5 XXI, Pakuwon Mall XXI, dan yang paling terbaru ada di The Breeze XXI BSD, Tangerang.</p>
                           <a href="#" class="btn mt-20"><i class="far fa-ticket-alt"></i> Buy Ticket</a>
                        </div>
                     </div>
                  </div>
                  <div class="col-lg-6">
                     <div class="s-video-wrap" style="background-image:url(img/bioskop.png)">
                        <div class="s-video-content">
                           <a href="https://www.youtube.com/watch?v=V2HZBSGJ8_A" class="popup-video mb-50"><i class="fas fa-play"></i></a>
                        </div>
                     </div>
                  </div>
               </div>
             ...
             <div class="container">
                <div class="row">
                   <div class="col-lg-6 col-sm-6">
                      <div class="about-title second-atitle">
                         <span class="wow fadeInUp animated" data-animation="fadeInUp animated" data-delay=".2s">The Premiere Cinema 21</span>
                         <h2 class="wow fadeInUp animated" data-animation="fadeInUp animated" data-delay=".2s"> Menghadirkan Pengalaman Nonton Dengan Teknologi Revolusioner Yaitu IMAX Teater</h2>
            ...
            <div class="container">
               ...
               <div class="row justify-content-center">
                  <div class="col-xl-8 col-lg-8">
                     <div class="section-title mb-80">
                        ...
                        <h2 class="wow fadeInUp animated" data-animation="fadeInUp animated" data-delay=".2s">Sponsors</h2>
                     </div>
                  </div>
               ...
               <div class="row">
                  <div class="col-lg-12 col-md-12 text-center">
                     <ul class="wow fadeInDown animated" data-animation="fadeInDown animated" data-delay=".2s">
                        <li><a href="https://satupintu.co.id" target="_blank"><img src="img/logo-satupintu-new.png" alt="SatuPintu" width="280px"></a></li>
                        <li><a href="https://sewaingame.com" target="_blank"><img src="img/logo-sewaingame-putih.png" alt="SewainGame" width="280px"></a></li>
                     </ul>
                  </div>
               </div>
            </div>
